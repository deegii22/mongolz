...
INSERT INTO  `USERS` (id,firstname, lastname,email,channel, is_admin, userCredId) VALUES (1,'Admin','Admin','admin@mongolz.com','SMS',1,'admin');
INSERT INTO `USERS` (id,firstname, lastname,email,channel, is_admin,userCredId) VALUES (2,'Enkhtulga','Tseveenkhuu','ts.enkh@wrench.com','EMAIL',1,'eta');
